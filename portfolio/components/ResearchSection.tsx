              ...
              >
                <CardBody className="flex flex-col gap-4 pt-4">
                  ...
                  >
                    ...
                    {showMedia ? (
                      <div className="relative w-full overflow-hidden rounded-lg border border-green-100 bg-white/60 dark:border-emerald-800/60 dark:bg-slate-800/60 lg:self-start">
                        {hasVideo && (
                          <Button
